...
func show_dialogue_balloon(resource: DialogueResource, title: String = "", extra_game_states: Array = [], custom_balloon_path: String = "") -> Node:
	var balloon_path: String = custom_balloon_path
	if balloon_path == "":
